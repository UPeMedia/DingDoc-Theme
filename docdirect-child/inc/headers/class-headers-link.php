          ...
          <table>
            <tr>
                ...
                if( is_user_logged_in() ) {
        						$id	= $current_user->ID; ?>
                    <a href="<?php echo get_home_url(); ?>/?page_id=4423&ref=private-chat&identity=<?php echo $id; ?>" ><i class="fa fa-inbox fa-2x"></i></a>
                <?php } ?>
                </td>
                <td>
                  <?php
                  /*if( is_user_logged_in() ) {
          						$id	= $current_user->ID; */?>
                      <a href="<?php echo get_home_url(); ?>/?page_id=4411" ><i class="fa fa-gift fa-2x"></i></a>
                  <?php //} ?>
                </td>
                ...
                <td>
                  ...
                  if( is_user_logged_in() ) {
                        ...
                        <a href="<?php echo get_home_url(); ?>/?page_id=4423&ref=bookings&identity=<?php echo $id; ?>" ><i class="fa fa-calendar-check-o fa-2x"></i></a>
                    
                  <?php }else{ ?>
                      <a href="<?php echo get_home_url(); ?>/?page_id=4417" ><i class="fa fa-question-circle fa-2x"></i></a>
                  <?php } ?>
                </td>
                <td>
                  <?php
                  ...
                  if( is_user_logged_in() ) {
          						$id	= $current_user->ID; ?>
                      <a href="<?php echo get_home_url(); ?>/?page_id=4423&ref=wishlist&identity=<?php echo $id; ?>" ><i class="fa fa-heart fa-2x"></i></a>
                  <?php } ?>
                </td>
             </tr>
           </table>
