...
if( !class_exists( 'docdirect_subheaders' ) ){
	class docdirect_subheaders{
		...
		function __construct(){
			add_action('docdirect_prepare_subheaders_link',array(&$this,'docdirect_prepare_subheaders_link'));
		}
		 ...
		 * @return {}
		 */
		public function docdirect_prepare_subheaders_link($post_id='') {
			global $post;
			...
			<div id="tg-innerbanner" class="tg-innerbanner tg-bglight tg-haslayout">
                ...
                <div class="tg-pagebar tg-haslayout <?php echo esc_attr( $is_opacity );?>">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
                                <h1 class="titulopage"><?php echo  esc_attr( $title );?></h1>
                                <?php
