...
if( !class_exists( 'DocDirect_Scripts_link' ) ) {
	class DocDirect_Scripts_link{
        ...
        public function docdirect_profile_menu( $menu_type="dashboard" ) {
                    ...
                    <?php if( $url_identity ==  $user_identity ) { ?>
                        ...
                        <?php }?>
	                      	...
	                      	<?php if(!empty($is_chat) && $is_chat === 'yes') { ?>
															<!-- <li class="<?php echo($reference === 'private-chat' ? 'active':''); ?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'private-chat', $user_identity); ?>"><?php esc_html_e('Inbox', 'docdirect'); ?></a></li> -->
	                        <?php } ?>
						              ...
						              <?php }?>
													<?php //articulos 4431 local ?>
													<li class="<?php echo ( $reference === 'articulos' ? 'active':'');?>"><a href="<?php echo get_home_url(); ?>/?page_id=4464&tipo=link">Artículos</a></li>
													<li class="<?php echo ( $reference === 'faq' ? 'active':'');?>"><a href="<?php echo get_home_url(); ?>/?page_id=4417">FAQ</a></li>
													<li class="<?php echo ( $reference === 'security' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'security', $user_identity); ?>">Seguridad</a></li>
													<li class=""><a href="<?php echo get_home_url(); ?>/?page_id=4420">Términos y condiciones</a></li>
														<?php
						              ...
						              <?php
													...
													<?php }?>
													<?php } else{?>
														<!-- <li class="<?php echo ( $reference === 'bookings' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'bookings', $user_identity); ?>"><?php esc_html_e('My appointmens','docdirect');?></a></li> -->
													<?php }?>
						              ...
						              <?php if ( is_user_logged_in() ) {?>
						                  <li><a href="<?php echo esc_url( wp_logout_url( home_url( '/?page_id=4398' ) ) ); ?>"><?php esc_html_e('Logout','docdirect');?></a></li>
						              <?php }?>
            ...
            <?php } else{
                ...
                <ul>
                    <li class="das <?php echo ( $reference === 'dashboard' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'dashboard', $user_identity); ?>"><i class="fa fa-line-chart"></i><?php esc_html_e('Profile','docdirect');?></a></li>
                    <?php if ( class_exists('bbPress') ) {?>
		...
		public static  function docdirect_profile_menu_link($profile_page = '', $slug = '', $user_identity = '',$return=false,$mode = '', $id = ''){
			if( !isset($profile_page) or $profile_page == '' ){
				$permalink = home_url('/').'?author='.$user_identity."&tipo=link";
			} else {
