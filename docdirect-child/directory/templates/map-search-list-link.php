...
<?php
  ...
  echo "<div style='display:none' class='uno' >";
  print_r($user_query);
  echo "</div>";
        ...
        <form class="doc-formtheme1 doc-formsearchwidget1 search-result-form1">
            <!-- <div class="row"> -->
                      ...
                      <div class="col-sm-12">
                          <div style="text-align:center;" class="ajustehome"> <?php echo $_GET['directory_type'];    ?>
                              <a href="#" onclick="openModal('especialistas')">
                                  <img src="https://dingdoc.com.gt/wp-content/uploads/2020/07/1-icono1m.png" /></a>
                          </div>
                          <div style="text-align:center;" class="ajustehome filacentro">
                              <a href="#" onclick="openModal('instituciones')">
                                  <img src="https://dingdoc.com.gt/wp-content/uploads/2020/07/1-icono2m.png" /></a>
                          </div>
                          <div style="text-align:center;" class="ajustehome">
                              <a href="#" onclick="openModal('farmacias')">
                                  <img src="https://dingdoc.com.gt/wp-content/uploads/2020/07/1-icono3m.png" /></a>
                          </div>
                      </div>
              ...
              <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 pull-right">
                ...
                $infoBox	.= '<figure class="tg-docimg"><a class="userlink" target="_blank" href="'.get_author_posts_url_link($user->ID).'"><img src="'.esc_url( $avatar ).'" alt="'.esc_attr( $directories_array['name'] ).'"></a>';
                ...
                $infoBox	.= '<h3><a class="userlink" target="_blank" href="'.get_author_posts_url_link($user->ID).'">'.$directories_array['name'].'</a></h3>';
                $infoBox	.= '</div>';
                ...
                $directories['users_list'][]	= $directories_array;
                              ...
                              <div class="doc-featurelist mobile" class="user-<?php echo intval( $user->ID );?>">
                                  <figure class="doc-featureimg">
                                      ...
                                      <a href="<?php echo get_author_posts_url_link($user->ID); ?>" class="list-avatar">
                                  ...
                                  <div class="doc-featurecontent">
                                    <div class="doc-featurehead">
                                      <?php //docdirect_get_wishlist_button($user->ID,true,'v2');?>
                                      <h2><a href="<?php echo get_author_posts_url_link($user->ID); ?>" class="list-avatar"><?php echo ( $get_username );?></a></h2>
                                      <?php
  																		$db_subcategory		    = get_user_meta( $user->ID, 'doc_sub_categories', true);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php do_action( 'docdirect_search_filters_link' );?>
      </div>
