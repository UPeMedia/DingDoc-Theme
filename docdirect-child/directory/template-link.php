...
$meta_query_args[] = array(
					...
					/*Premium  3245
						...
						Institucional 4027*/
					/*$meta_query_args[] = array(
											'key'     => 'user_current_package',
											'value'   => '3245',
											'compare' => '='
					);*/

					$paquetesAr = ['3245','4026','3247','4027'];
					$query_relation = array('relation' => 'OR',);
					$paquetes_args	= array();
					foreach( $paquetesAr as $key => $value ){
						$paquetes_args[] = array(
												'key' 		=> 'user_current_package',
												'value'   	=> $value,
												'compare' 	=> 'LIKE',
...
$meta_query_args[]	= array_merge( $query_relation,$paquetes_args );
/*fin si tiene paquete */
...
echo "<div style='display:none' class='linkdatatest'><pre>";
...
if( isset( $dir_listing_type ) && $dir_listing_type === 'left' ){
	...
	include(locate_template('directory/templates/map-search-list-link.php')); //cambioabre template link
}
