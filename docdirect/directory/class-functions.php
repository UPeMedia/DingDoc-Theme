        ...
        public function docdirect_profile_menu( $menu_type="dashboard" ) {
            ...
            <div class="tg-widget tg-widget-accordions">
                ...
                <ul class="docdirect-menu">
                    <?php if( $url_identity ==  $user_identity ) { ?>
                        <li class="menuperfil <?php echo ( $reference === 'dashboard' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'dashboard', $user_identity); ?>"><?php esc_html_e('My Profile','docdirect');?></a></li>
                        ...
                        <?php }?>
                        	...
                        	<!-- sin ajuste para usuario doctor -->
												<?php }else{ ?>
												...
												<?php if( apply_filters('docdirect_do_check_user_type',$user_identity ) === true ){?>
                        	<!-- <li class="<?php echo ( $reference === 'documents' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'documents', $user_identity); ?>"><?php esc_html_e('Medical Documents','docdirect');?></a></li>
                        	<li class="<?php echo ( $reference === 'insurance' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'insurance', $user_identity); ?>"><?php esc_html_e('Insurance Documents','docdirect');?></a></li> -->
                        <?php }?>
                        ...
                        <?php if( isset( $article_switch ) && $article_switch === 'enable' ){?>
							<?php if ( function_exists('fw_get_db_settings_option') && fw_ext('articles')) { ?>
								<li class="tg-privatemessages tg-hasdropdown <?php echo ( $reference === 'articles' ? 'tg-active' : ''); ?>">
									<a id="tg-btntoggle" class="tg-btntoggle menuarticulos" href="javascript:" >
										<span><i class="fa fa-pencil"></i> <?php esc_html_e('Manage Articles', 'docdirect'); ?></span>
                      	...
                      	<?php if(!empty($is_chat) && $is_chat === 'yes') { ?>
							<li class="menuchat <?php echo($reference === 'private-chat' ? 'active':''); ?>">
								<a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'private-chat', $user_identity); ?>">
									<i class="fa fa-comment-o"></i> <?php esc_html_e('Inbox', 'docdirect'); ?></a></li>
                        <?php } ?>
                        <?php if( apply_filters('docdirect_do_check_user_type',$user_identity ) === true){?>
                        ...
                        <?php if( apply_filters('docdirect_do_check_user_type',$user_identity ) === true ){?>
                            <li class="menuchat <?php echo ( $reference === 'invoices' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'invoices', $user_identity); ?>"><i class="fa fa-money"></i><?php esc_html_e('Invoices & Packages','docdirect');?></a></li>
                        <?php }?>
                        <?php
                        ...
                        <?php if( apply_filters('docdirect_do_check_user_type',$user_identity ) === true ){?>
							<?php if( apply_filters('docdirect_is_setting_enabled',$user_identity,'appointments' ) === true){?>
								<li class="menulistado <?php echo ( $reference === 'bookings' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'bookings', $user_identity); ?>"><i class="fa fa-book"></i><?php esc_html_e('Booking Listings','docdirect');?></a></li>
							<?php }?>
						<?php } else{?>
							<li class="menulistado <?php echo ( $reference === 'bookings' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'bookings', $user_identity); ?>"><i class="fa fa-book"></i><?php esc_html_e('My appointmens','docdirect');?></a></li>
						<?php }?>
                        ...
                        <?php
                            ...
                            <li class="menuhorarios <?php echo ( $reference === 'booking-schedules' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'booking-schedules', $user_identity); ?>"><i class="fa fa-calendar-check-o"></i><?php esc_html_e('Booking Schedules','docdirect');?></a></li>
                        <?php }?>
                        <?php
							if( apply_filters('docdirect_do_check_user_type',$user_identity ) === true
							    && apply_filters('docdirect_is_setting_enabled',$user_identity,'appointments' ) === true
                        ...
                        <li class="menuajustes <?php echo ( $reference === 'security' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'security', $user_identity); ?>"><i class="fa fa-lock"></i><?php esc_html_e('Security Settings','docdirect');?></a></li>
                        ...
                        <?php if ( is_user_logged_in() ) {?>
                            <li class="menulogout"><a href="<?php echo esc_url( wp_logout_url( home_url( '/' ) ) ); ?>"><i class="fa fa-sign-in"></i><?php esc_html_e('Logout','docdirect');?></a></li>
                        <?php }?>
            ...
            <?php } else{
                ...
                <ul class="menuflotante">
                    ...
                    <?php if( apply_filters('docdirect_do_check_user_type',$user_identity ) === true ){?>
                   		<!-- <li class="<?php echo ( $reference === 'documents' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'documents', $user_identity); ?>"><i class="fa fa-file"></i><?php esc_html_e('Medical Documents','docdirect');?></a></li>
                   		<li class="<?php echo ( $reference === 'insurance' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'insurance', $user_identity); ?>"><i class="fa fa-file"></i><?php esc_html_e('Insurance Documents','docdirect');?></a></li> -->
                    <?php }?>
                    ...
                    <?php if( isset( $article_switch ) && $article_switch === 'enable' ){?>
                  	...
                  	<?php if(!empty($is_chat) && $is_chat === 'yes') { ?>
						<li class="<?php echo ( $reference === 'private-chat' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'private-chat', $user_identity); ?>"><i class="fa fa-comment-o"></i><?php esc_html_e('Inbox','docdirect');?></a></li>
					<?php } ?>
                    ...
                    <?php if( apply_filters('docdirect_do_check_user_type',$user_identity ) === true ){?>
                        ...
                        <?php }?>
                    <?php } else{?>
                    	<li class="<?php echo ( $reference === 'bookings' ? 'active':'');?>"><a href="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'bookings', $user_identity); ?>"><i class="fa fa-book"></i><?php esc_html_e('My appointmens','docdirect');?></a></li>
                    <?php }?>
		...
		public function docdirect_do_process_userinfo(){
			...
			<div class="tg-dashboard tg-haslayout">
				<div class="tg-docprofilechart tg-haslayout">
					<div class="homecol1 col-lg-8 col-md-7 col-sm-12 col-xs-12 tg-findheatlhwidth">
						<div class="row">
					...
					<div class="homecol2 col-lg-4 col-md-5 col-sm-12 col-xs-12 tg-expectwidth">
						<div class="row">
