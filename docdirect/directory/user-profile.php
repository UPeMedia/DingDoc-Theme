			...
			<?php
				if( isset( $_GET['ref'] )
					...
					if( apply_filters('docdirect_do_check_user_type',$url_identity ) === true  ){
						...
						get_template_part('directory/bookings/templates/customer','bookings');
					}
					...
					if( apply_filters('docdirect_do_check_user_type',$url_identity ) === true  ){
						if( apply_filters('docdirect_is_setting_enabled',$url_identity,'appointments' ) === true  ){
							get_template_part('directory/bookings/templates/user','bookingsm');
						}
					} else{
						get_template_part('directory/bookings/templates/customer','bookingsm');
					}
