        ...
        <div class="booking-settings-data">
            <div class="tg-dashboard tg-docappointment tg-haslayout">
              ...
              <ul class="tg-navdocappointment" role="tablist">
                <li role="presentation" class="<?php echo $tab1; ?>"><a href="#one" aria-controls="one" role="tab" data-toggle="tab"><?php esc_html_e('offer service(s) and fee','docdirect');?></a></li>
                <li role="presentation" class="<?php echo $tab2; ?>"><a href="#two" aria-controls="two" role="tab" data-toggle="tab"><?php esc_html_e('Time slot(s)','docdirect');?></a></li>
              ...
              <div class="tab-content tg-appointmenttabcontent">
								...
								?>
                <div role="tabpanel" class="tab-pane <?php echo $tab1; ?>" id="one">
                ...
                <div role="tabpanel" class="tab-pane <?php echo $tab2; ?>" id="two">
                  <div class="tg-heading-border tg-small">
                    <h3>Horarios Disponibles</h3>
                  </div>
									<!-- cambio horarios - se agrego select de servicios-->
									<script>
									function myFunction(chosen) {
										var servicio = chosen.replace(/\s/g, '');
										//var servicio = (chosen.replace(/\s/g, '')).toLowerCase();
									  window.location.href = '?page_id=22&ref=booking-schedules&identity=<?php echo $user_identity; ?>'+'&servicio='+servicio;
									}
									</script>
									<div class="tg-heading-border tg-small">
										<div class="form-group">
											<div class="tg-select">
													<select name="service_category" class="service_category" onChange="myFunction(this.options[this.selectedIndex].value)">
															...
															<?php
																/*if( !empty( $booking_services ) ) {
																	foreach( $booking_services as $key => $value ){
																		...
																		?>
																				<option <?php if ($servicio == str_replace(' ', '', $key)) {echo "selected";}?>  value="<?php echo $key;?>"><?php echo $titulo;?></option>
									...
									<?php
									 ...
									 if ($servicio !== ''){
									?>
												<input type="hidden" name="servicioval" value="<?php echo $servicio;?>" />
			                    ...
			                    <div class="tg-timeslots">
			                        <div class="timeslots-data-area">
																<?php
																//cambio horario
																//docdirect_get_default_slots('sun','echo');?>
			                        	<?php docdirect_get_default_slots('sun',$servicio,'echo');?>
			                  ...
			                  <div class="tg-daytimeslot" data-day="mon">
			                    ...
			                    <div class="tg-timeslots">
			                        <div class="timeslots-data-area">
																<?php //cambio horarios ?>
			                        	<?php docdirect_get_default_slots('mon',$servicio,'echo');?>
			                        </div>
			                        <div class="timeslots-form-area">
			                        </div>
			                    </div>
			                  ...
			                  <div class="tg-daytimeslot" data-day="tue">
			                    ...
			                    <div class="tg-timeslots">
			                        <div class="timeslots-data-area">
			                        	<?php docdirect_get_default_slots('tue',$servicio,'echo');?>
			                        </div>
			                        <div class="timeslots-form-area">
			                        </div>
			                    </div>
			                  ...
			                  <div class="tg-daytimeslot"  data-day="wed">
			                    ...
			                    <div class="tg-timeslots">
			                        <div class="timeslots-data-area">
			                        	<?php docdirect_get_default_slots('wed',$servicio,'echo');?>
			                        </div>
			                        <div class="timeslots-form-area">
			                        </div>
			                    </div>
			                  ...
			                  <div class="tg-daytimeslot"  data-day="thu">
			                    ...
			                    <div class="tg-timeslots">
			                        <div class="timeslots-data-area">
			                        	<?php docdirect_get_default_slots('thu',$servicio,'echo');?>
			                        </div>
			                        <div class="timeslots-form-area">
			                        </div>
			                    </div>
			                  ...
			                  <div class="tg-daytimeslot"  data-day="fri">
			                    ...
			                    <div class="tg-timeslots">
			                        <div class="timeslots-data-area">
			                        	<?php docdirect_get_default_slots('fri',$servicio,'echo');?>
			                        </div>
			                        <div class="timeslots-form-area">
			                        </div>
			                    </div>
			                  ...
			                  <div class="tg-daytimeslot" data-day="sat">
			                    ...
			                    <div class="tg-timeslots">
			                        <div class="timeslots-data-area">
			                        	<?php docdirect_get_default_slots('sat',$servicio,'echo');?>
			                        </div>
			                        <div class="timeslots-form-area">
			                        </div>
			                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="three">
                                    ...
                                    <div class="tg-timeslots tg-fieldgroup">
                                      <div class="tg-timeslotswrapper">
                                        <div class="form-group tg-calender">
																					...
																					<?php //cambio hidden to text  ?>
																					<div>

																						<?php
																						//json_decode($value['custom_time_slots']);

																						if(isJSON($value['custom_time_slots'])) {
																							?>
	 																							<input type="hidden" class="custom_time_slots" name="custom_time_slots" value="<?php echo htmlentities(stripslashes(($value['custom_time_slots']))); ?>" />
			              							  						<input type="hidden" class="custom_time_slot_details" name="custom_time_slot_details" value="<?php echo htmlentities(stripslashes(($value['custom_time_slot_details']))); ?>" />
																							<?php
																						}else{ ?>
																								<input type="hidden" class="custom_time_slots" name="custom_time_slots" value='<?php echo stripslashes(json_encode($value['custom_time_slots'])); ?>' />
																								<input type="hidden" class="custom_time_slot_details" name="custom_time_slot_details" value='<?php echo stripslashes(json_encode($value['custom_time_slot_details'])); ?>' />
																						<?php
																					}
																						?>
                  ...
                  <div class="tg-daytimeslot custom-slots-action">
                     ...
                     <button class="tg-btn bk-save-custom-slots" type="button" style="display: none;"><?php esc_html_e('Save Time Slots','docdirect');?></button>
                  </div>
                </div>
              </div>
            </div>
		...
		<div class="form-group">
		  <div class="tg-select">
			<select name="meeting_time" class="meeting_time">
				<option value="">Duración de consulta</option>
		...
		<div class="form-group">
		  <div class="tg-select">
			<select name="padding_time" class="padding_time">
				...
				<option value="0">0 <?php esc_attr_e('minutes','docdirect');?></option>
				<option value="5">5 <?php esc_attr_e('minutes','docdirect');?></option>
				<option value="10">10 <?php esc_attr_e('minutes','docdirect');?></option>
				<option value="15">15 <?php esc_attr_e('minutes','docdirect');?></option>
				<option value="20">20 <?php esc_attr_e('minutes','docdirect');?></option>
...
<script type="text/template" id="tmpl-custom-slots">
	<div class="tg-timeslotswrapper">
		<form action="#" method="post" class="time-slots-form">
			...
			<div class="tg-btnbox">
			  <button type="submit" class="tg-btn save-custom-time-slots">Crear espacios</button>
			  <button type="submit" class="tg-btn remove-slots-form"><?php esc_html_e('Cancel','docdirect');?></button>
			</div>
		  </div>
		</div>
