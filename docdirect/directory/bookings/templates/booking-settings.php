             	...
             	<div class="email-logo tg-editimg booking-email-wrap">
                    ...
                    <div class="tab-data">
                        <figure class="tg-docimg"> 
                            ...
                            <?php }?>
                            <div id="plupload-container"><a href="javascript:;" id="upload-email" class="tg-uploadimg upload-email"><i class="fa fa-upload"></i></a> </div>
                        </figure>
             	...
             	<div class="appointment-email booking-email-wrap">
                    ...
                    <div class="tab-data">
                        <div class="email-params">
                            ...
                            <p><strong>%appointment_note%</strong>&nbsp;-- <?php esc_html_e('Appointment note written by users','docdirect');?></p>
                            <p><strong>%phone%</strong>&nbsp;-- <?php esc_html_e('To display customer phone number','docdirect');?></p>
                            <p><strong>%email%</strong>&nbsp;-- <?php esc_html_e('To display customer email address','docdirect');?></p>
                            <p><strong>%address%</strong>&nbsp;-- <?php esc_html_e('Your company/individual address.','docdirect');?></p>
                            <p><strong>%category%</strong>&nbsp;-- <?php esc_html_e('To display category in which appointment is made','docdirect');?></p>
                            ...
                            <p><strong>%payment_method%</strong>&nbsp;-- <?php esc_html_e('Payment method','docdirect');?></p>
