...
//Mañana +18 horas porque esta adelantado 6 horas
$hoy = date("Y-m-d",strtotime('+18 hour'));
//hora actual
...
//echo $hoy;
			...
			if( $query->have_posts() ):
				 while($query->have_posts()) : $query->the_post();
						...
						//echo $bk_code." ".$horamas2." ".(int)$horacita."<br>";
...
//echo "citas enviadas: ".$citas;
$mensaje = "Mensaje enviados: ".$enviados."\nCitas: ". $citas;
$mensaje = wordwrap($mensaje, 70, "\r\n");
mail('figarcia@gmail.com', 'Cron push 24hrs', $mensaje);
?>
