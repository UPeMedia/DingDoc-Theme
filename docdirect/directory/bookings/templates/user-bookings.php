...
<div class="doc-booking-listings dr-bookings">
  <div class="tg-dashboard tg-docappointmentlisting tg-haslayout">
    ...
    <form autocomplete="off" class="tg-formappointmentsearch" action="<?php DocDirect_Scripts::docdirect_profile_menu_link($profile_page, 'bookings', $user_identity); ?>" method="get">
      <fieldset>
		...
		<span style="width:100%; text-align:center; display:block"><a href="<?php echo get_home_url(); ?>/?page_id=<?php echo esc_attr( $page_idn );?>&ref=bookingsm&identity=<?php echo intval( $user_identity ); ?>&by_date=<?php echo $_GET['by_date']; ?>" >Ver semana.</a></span>
		<div class="diasbar">
        ...
        <?php
          ...
          <tr class="<?php echo esc_attr( $trClass );?> booking-<?php echo intval( $post->ID );?>">
            ...
            <td data-name="subject" class="citassubject get-detail"  href="javascript:;">
							...
							<span><?php echo esc_attr( $bk_subject );?></span>
		                ...
		                <div class="appointment-data-wrap">
		                    <ul class="tg-leftcol">
		                      ...
		                      <?php if( !empty( $payment_amount ) ){?>
		                          <!-- <li>
		                                <strong><?php
																		esc_html_e('Appointment Fee','docdirect');?>:</strong>
            ...
            <td style="width: 33%;">
            	<?php if( isset( $bk_status ) && $bk_status == 'approved' ){?>
                	<a class="tg-btncheck appointment-actioned" href="javascript:;"><?php esc_html_e('Approved','docdirect');?></a>
                ...
                <?php }else {?>
                     <a class="tg-btncheck get-process" data-type="approve" data-id="<?php echo intval( $post->ID );?>" href="javascript:;">
