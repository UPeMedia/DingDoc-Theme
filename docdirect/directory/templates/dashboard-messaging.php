            ...
            <div class="wt-dashboardbox wt-messages-holder">
                <div class="wt-chat-head">
	                <div class="wt-dashboardboxtitle">
	                   <h2><?php esc_html_e('Messages', 'docdirect'); ?></h2>
					</div>
				...
				<div class="wt-dashboardboxcontent wt-dashboardholder wt-offersmessages">
					<?php
						if (isset($_GET['ref']) && $_GET['ref'] == 'private-chat' && $_GET['identity'] == $user_identity) {
...
<div class="wt-replaybox">
	<div class="form-group">
		<textarea class="form-control reply_msg" name="reply" placeholder="<?php esc_html_e('Type message here', 'docdirect'); ?>"></textarea>
	</div>
	<div class="wt-iconbox">
		<a href="javascript:;" class="wt-btnsendmsg wt-send" data-status="unread" data-receiver_id="{{data.receiver_id}}"><?php esc_html_e('Send', 'docdirect'); ?></a>
	</div>
</div>
</script>
...
<div class="{{chat_class}}" data-id="{{element.chat_id}}">
	...
	<div class="wt-description">
		...
		<time datetime="2019-08-08">{{element.chat_date}}</time>
		<div class="clearfix"></div>
	</div>
</div>
<# }); #>
...
<a href="javascript:;" class="wt-back back-chat"><i class="fa fa-arrow-left"></i></a>
<div class="wt-userlogedin">
	...
	<div class="wt-username">
		...
		<!-- <a target="_blank" href="{{data.chat_url}}" class="wt-viewprofile"><?php esc_html_e('View Profile', 'docdirect'); ?></a> -->
	</div>
</div>
<!-- <a href="{{data.chat_url}}" target="_blank" class="wt-viewprofile proflink"><span class="fa fa-unlink"></span></a> -->
</script>
