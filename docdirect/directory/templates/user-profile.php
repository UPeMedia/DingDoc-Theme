...
Institucional 4027
*/
if ( (get_user_meta( $current_user->ID, 'user_current_package', true) == 3245)  )
	{
 ?>
<div class="tg-graph tg-haslayout">
	<div class="tg-profilehits">
		<div class="tg-heading-border tg-small">
			<hp><?php esc_html_e('Profile Hits','docdirect');?></p>
		</div>
		<canvas id="canvas" class="canvas"></canvas>
	</div>
</div>
<?php //cambio, no muetra comentarios de clientes    antes val === true ?>
<?php if( apply_filters('docdirect_do_check_user_type',$url_identity ) === true1 ){?>
