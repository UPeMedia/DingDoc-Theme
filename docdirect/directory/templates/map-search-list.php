...
echo "<div style='display:none' class='userquery'>";
print_r($user_query);
echo "</div>";
                    ...
                    <div class="doc-sortby">
                     <span class="doc-select">
                      <select name="sort_by" class="sort_by" id="sort_by">
                          ...
                          <option value="distance" selected <?php //echo isset( $_GET['sort_by'] ) && $_GET['sort_by'] == 'distance' ? 'selected' : '';?>><?php esc_html_e('Sort By Distance','docdirect');?></option>
                    ...
                    if ( ! empty( $user_query->results ) ) {
                        ...
                        foreach ( $user_query->results as $user ) {
							...
							/*Premium  3245
								...
								Basico 3247
								Institucional 4027*/
								//$current_package   = get_user_meta( $user->ID, 'user_current_package', true);
								//echo "current_package: ".$current_package;
								//se elimino poque se valida en user_search.php en el armado de query
								//if  ( ($current_package== 3245) || ($current_package== 4026) || ($current_package== 3247) || ($current_package== 4027)){ //val si tiene
                            ...
                            <div class="doc-featurelist" class="user-<?php echo intval( $user->ID );?>">
                                <figure class="doc-featureimg">
                                    ...
                                    <?php //do_action('docdirect_display_provider_category',$user->ID);?>
																		...
																		<?php
																		if ($subcategory){ ?>
																			<a class="docscategory doc-themetag tg-categorytag sp-av-link" <?php echo esc_attr($bg_color); ?>   href="#">
																				<?php echo $categoria;   ?>
																			</a>
																		<?php
																	}else{
																		//do_action('docdirect_display_provider_category',$user->ID);
																	}
																		?>
                                </figure>
                                <div class="doc-featurecontent">
                                  ...
                                  <?php }?>
																	...
																	<?php
																	//si usuario logueado se muestran datos
                                  ...
                                  <ul class="doc-addressinfo">
									...
									<?php }?>
																	...
																	<?php
																		//Final - si usuario logueado se muestran datos
																		}
																	?>
                                </div>
                            </div>

												<?php  //} //termino val si tiene paquete ?>
                        <?php
                        }
                     } else{?>
