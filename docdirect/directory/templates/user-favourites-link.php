  ...
  <div class="tg-listing">
    <div class="tg-listing-head">
      <div class="tg-titlebox">
        <h2><i class="fa fa-heart-o fa-2x" aria-hidden="true"></i><br>
  				 Mis favoritos</h2>
      </div>
      <!-- <div class="tg-titlebox">
			...
			if ( ! empty( $user_query->results ) ) {
			  ...
			  <div class="tg-list" id="wishlist-<?php echo intval($user->ID); ?>">
				<div class="tg-listbox" data-title="my favorites">
				  <figure><a href="<?php echo get_author_posts_url($user->ID); ?>&tipo=link" class="list-avatar"><img src="<?php echo esc_attr( $avatar );?>" alt="<?php echo esc_attr( $directories_array['name'] );?>"></a></figure>
				  <div class="tg-listdata">
					<h4><a href="<?php echo get_author_posts_url($user->ID); ?>&tipo=link"><?php echo esc_attr( $directories_array['name'] );?></a></h4>
				  </div>
				</div>
				...
				<div class="tg-listbox" data-action="action">
					<a class="tg-btn-list" href="<?php echo get_author_posts_url($user->ID); ?>&tipo=link"><i class="fa fa-eye"></i></a>
