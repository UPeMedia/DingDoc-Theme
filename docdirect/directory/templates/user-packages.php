                        ...
                        <div class="tg-checkbox">
                            ...
                            <label for="pack-<?php echo esc_attr( $pack->ID );?>">
                                <div class="tg-packages <?php echo esc_attr( $active_class );?>">
                                    ...
                                    <?php }?>
									<ul>
										<li><i class="fa fa-check"></i><span><?php echo esc_html_e( 'Featured listing','docdirect' );?>&nbsp;x&nbsp;<?php echo intval($duration);?>&nbsp;<?php esc_html_e( 'Day(s)','docdirect' );?></span></li>
										<?php if( !empty( $features ) && is_array($features) ){
											foreach( $features as $key => $value ){?>
											<li><i class="fa fa-check"></i><span><?php echo esc_attr( $value );?></span></li>
										<?php }}?>
									</ul>
