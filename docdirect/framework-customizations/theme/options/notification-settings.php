						...
						'options' => array(
							...
							'appointment_info' => array(
								...
								'html'  => '%logo% — To display site logo.<br/>
											...
											%appointment_note% — To display Appointment note written by users<br/>
											%phone% — To display To display customer phone number<br/>
											%email% — To display To display customer email address<br/>
											%address% — To display Your company/individual/doctor address.<br/>
											%category% — To display To display category in which appointment is made<br/>
											%service% — To display To display appointment service<br/>
											%provider% — To display To display provider name<br/>
											%appointment_date% — To display Appointment Date<br/>
											%appointment_time% — To display Appointment Time<br/>
											%payment_method% — To display Payment method<br/>
