...
if (!function_exists('docdirect_prepare_constants')) {
    function docdirect_prepare_constants() {
		...
		$unit	= docdirect_get_distance_scale();
		$distance_unit = !empty( $unit ) && $unit === 'Mi' ? esc_html__(' Mi','docdirect') : esc_html__(' Km','docdirect');
		...
		wp_localize_script('docdirect_user_profile', 'scripts_vars', array(
			...
			'sp_upload_brochure' => esc_html__('Upload Medical Files','docdirect'),
