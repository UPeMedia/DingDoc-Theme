...
if (!function_exists('docdirect_edit_user_profile_edit')) {
    ...
    function docdirect_edit_user_profile_edit($user_identity) {
        ...
        <table class="form-table profilebanneradmin">
            <tbody>
                <tr>
...
if (!function_exists('docdirect_personal_options_save')) {
    ...
    function docdirect_personal_options_save($user_identity) {
		...
		$secondary_email 	= !empty( $_POST['secondary_email'] ) ? docdirect_isValidEmail( $_POST['secondary_email'] ) : '';
		update_user_meta($user_identity, 'secondary_email', $secondary_email);
		...
		$updated_pack_id	= !empty( $_POST['current_package'] ) ? intval( $_POST['current_package'] ) : '';
